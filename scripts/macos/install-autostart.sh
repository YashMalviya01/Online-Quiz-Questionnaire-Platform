...
chmod +x "$PROJECT_DIR/scripts/macos/configure-ngrok.sh"
...
echo -e "   Configure Ngrok:  ${GREEN}./scripts/macos/configure-ngrok.sh${NC}"
echo ""
...
echo ""
echo -e "${BLUE}🌐 Configure Ngrok (for public access):${NC}"
echo -e "   ${GREEN}./scripts/macos/configure-ngrok.sh${NC}"
echo -e "   Or read: ${GREEN}docs/setup/NGROK_SETUP.md${NC}"
echo ""
